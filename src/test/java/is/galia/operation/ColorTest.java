...
class ColorTest extends BaseTest {
    ...
    @Test
    void fromStringWithNullArgument() {
        assertNull(Color.fromString(null));
    }

    @Test
    void fromStringWithCSSLevel1ColorName() {
    ...
    @Test
    void fromStringWithCSSLevel2ColorName() {
        assertEquals(new Color(255, 165, 0), Color.fromString("orange"));
    }

    @Test
    void fromStringWithCSSLevel3ColorName() {
