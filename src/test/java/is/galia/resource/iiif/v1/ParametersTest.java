...
class ParametersTest extends BaseTest {
    ...
    @Test
    void constructorWithInvalidQuality() {
        assertThrows(IllegalClientArgumentException.class,
                () -> new Parameters(
    ...
    @Test
    void constructorWithUnsupportedOutputFormat() {
    ...
    void toOperationList() {
        ...
        OperationList opList = instance.toOperationList(delegate);
    ...
    @Test
    void toOperationListOmitsScaleIfSizeIsFull() {
        Delegate delegate = TestUtils.newDelegate();
        instance = new Parameters(
    ...
    @Test
    void testToString() {
        assertEquals("identifier/0,0,200,200/pct:50/5/native.jpg",
                instance.toString());
    }
