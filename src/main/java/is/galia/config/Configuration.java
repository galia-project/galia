...
public interface Configuration {
     ...
     */
    static Configuration forApplication() {
        return ConfigurationFactory.appInstance();
    }
    ...
    /**
     * @return The file backing the instance, if any.
     */
     ...
     *         value if the target value is null or cannot be coerced to a
     *         byte size.
     * @see StringUtils#toByteSize(String)
    ...
    /**
     * @return Object value corresponding to the given key, or {@code null} if
     *         not set.
     */
    ...
    /**
     * @return String value corresponding to the given key, or {@code null} if
     *         not set.
     */
