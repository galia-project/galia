...
public final class AuthInfo {
    ...
    public static final class RestrictiveBuilder extends Builder {
        ...
        public RestrictiveBuilder withRedirectScaleConstraint(Number numerator,
                                                              Number denominator) {
            authInfo.scaleConstraintNumerator = (numerator != null) ?
                    numerator.intValue() : 0;
    ...
    /**
     * @return Value of the {@literal WWW-Authenticate} header. Will be non-
     *         {@code null} when {@link #getResponseStatus()} returns {@code
     *         401}, and {@code null} otherwise.
     */
    ...
    /**
     * @return URI to redirect to. Will be {@code null} unless {@link
    ...
    /**
     * @return HTTP 3xx- or 4xx-level status code. May be {@code null}.
     */
    ...
    /**
     * @return Virtual scale-constrained image to redirect to. May be {@code
     *         null}.
     */
