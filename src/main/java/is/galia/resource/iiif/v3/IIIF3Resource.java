...
abstract class IIIF3Resource extends IIIFResource {
     ...
     * Key#IIIF_3_ENDPOINT_PATH} in the application configuration.
     */
    public static final String DEFAULT_URI_PATH = "/iiif/3";
    ...
    public static String getURIPath() {
        String path = Configuration.forApplication()
                .getString(Key.IIIF_3_ENDPOINT_PATH, DEFAULT_URI_PATH);
