...
public abstract class Scale implements Operation {
    ...
    public enum Filter implements Operation {
        ...
        MKS2013("MKS2013",   ResampleFilters.getMagicKernelSharp2013Filter()),
        ...
        /**
         * @return Map with a {@code name} key and string value
     ...
     */
    public abstract ReductionFactor getReductionFactor(Size reducedSize,
                                                       ScaleConstraint scaleConstraint,
                                                       int maxFactor);
     ...
     *                        given full size.
     */
    public abstract double[] getResultingScales(Size fullSize,
                                                ScaleConstraint scaleConstraint);
     ...
     */
    public abstract Size getResultingSize(Size imageSize,
                                          ReductionFactor reductionFactor,
                                          ScaleConstraint scaleConstraint);

    /**
     * @return Whether the instance would effectively upscale the image it is
     *         applied to on the Y axis.
     */
    public boolean isHeightUp(Size comparedToSize,
                              ScaleConstraint comparedToScaleConstraint) {
        Size resultingSize = getResultingSize(
     ...
     */
    public boolean isUp(Size comparedToSize,
                        ScaleConstraint comparedToScaleConstraint) {
        Size resultingSize = getResultingSize(
                comparedToSize, comparedToScaleConstraint);
    ...
    /**
     * @return Whether the instance would effectively upscale the image it is
     *         applied to on the X axis.
     */
    public boolean isWidthUp(Size comparedToSize,
                             ScaleConstraint comparedToScaleConstraint) {
        Size resultingSize = getResultingSize(
                comparedToSize, comparedToScaleConstraint);
    ...
    public Map<String,Object> toMap(Size fullSize,
                                    ScaleConstraint scaleConstraint) {
        final Size resultingSize =
                getResultingSize(fullSize, scaleConstraint);
        return Map.of(
                "class", getClass().getSimpleName(),
                "width", resultingSize.longWidth(),
                "height", resultingSize.longHeight());
    }
